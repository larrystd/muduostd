...
void ProcessInspector::registerCommands(Inspector* ins) // 向Inspector中添加内容
{
...
string ProcessInspector::threads(HttpRequest::Method, const Inspector::ArgList&)  // 监视线程状况
{
