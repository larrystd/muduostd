...
class SudokuRequest final :
 ...
 public:
  ...
  explicit constexpr SudokuRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_checkerboard();
...
class SudokuResponse final :
 ...
 public:
  ...
  explicit constexpr SudokuResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void SudokuRequest::set_checkerboard(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 checkerboard_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SudokuRequest::_internal_set_checkerboard(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  checkerboard_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SudokuRequest::_internal_mutable_checkerboard() {
  _has_bits_[0] |= 0x00000001u;
  return checkerboard_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SudokuRequest::release_checkerboard() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return checkerboard_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
